...
**Muhammad Ovais Jahanzaib** — Software Engineer & Data Scientist.

- GitHub: [@ovaisi](https://github.com/ovaisi)
- LinkedIn: [ovaisjanzeb](https://www.linkedin.com/in/ovaisjanzeb/)
- Website: [datazeb.com](https://datazeb.com) — consulting & development

MDF2Excel is 100% free and open source — no paywall, no trial, ever. It's
built and maintained in spare time.

If it recovered records you thought were gone, or saved you an afternoon of
manual export work, the price of a coffee is a small way to say thanks:

[☕ Buy me a coffee](https://janzeb.gumroad.com/l/sjkzgm)

Your support keeps the tool free, updated, and available to the next person
who's stuck with an old `.mdf` file and no SQL Server.

Need hands-on help with a migration, data recovery, or custom build? I'm
available for consulting at [datazeb.com](https://datazeb.com).
